...
@NamedQueries({
	...
	@NamedQuery(name=Livro.LIVROS_EM_ESTOQUE_POR_TITULO, query="select l from Livro l where l.quantidadeEmEstoque > 0 and l.titulo like :tituloLivro" ),
...
public abstract class Livro implements Produto, Promocional {
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((quantidadeEmEstoque == null) ? 0 : quantidadeEmEstoque
						.hashCode());
